...
export const boots = {
  boot1: {
    ...
    desc: 'Everyones favorite white boot. We will cut it to the size you need and ship it.',
    price: 1724,
    status: 'available'
  },
  ...
  boot6: {
    ...
    image: 'https://i.istockimg.com/file_thumbview_approve/56241842/5/stock-photo-56241842-salmon-boot.jpg',
